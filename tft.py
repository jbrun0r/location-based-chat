...
class ClienteChat:
    def __init__(self, root):
        ...
        self.usuarios = {}  # {username: (lat, lon, ip, porta)}
        self.mensagens = []  # Histórico do chat
        self.iniciado = False  
    ...
    def monitorar_vizinhos(self):
        """Atualiza lista de usuários no ComboBox."""
        self.publicar_localizacao()  
        ...
        if lista_usuarios:
            self.combobox_usuarios.current(0)  
    ...
    def on_message(self, client, userdata, msg):
        ...
        try:
            ...
            if msg.topic.startswith(TOPICO_GERAL):
                ...
                if None not in (username, latitude, longitude, ip, porta_rpc):
